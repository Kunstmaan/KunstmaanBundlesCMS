...
/**
 * @ORM\Entity
 * @ORM\Table(name="kubu_video_page_parts")
 */
class VideoPagePart extends AbstractPagePart
{
    ...
    {
	return "kumaBundlesWebsiteBundle:PageParts/VideoPagePart:view.html.twig";
    }
    ...
    {
	return new \kumaBundles\WebsiteBundle\Form\PageParts\VideoPagePartAdminType();
    }
}
