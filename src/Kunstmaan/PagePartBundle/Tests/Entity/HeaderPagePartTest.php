...
class HeaderPagePartTest extends TestCase
{
    ...
    public function testSetGetNiv()
    {
        ...
        $this->assertSame(5, $this->object->getNiv());
    }

    public function testSetGetTitle()
    {
        $this->object->setTitle('A test title');
        $this->assertSame('A test title', $this->object->getTitle());
    }

    public function testToString()
    {
        $this->object->setTitle('A test title');
        $this->assertSame('HeaderPagePart A test title', $this->object->__toString());
    }

    public function testGetDefaultView()
    {
        $this->assertSame('@KunstmaanPagePart/HeaderPagePart/view.html.twig', $this->object->getDefaultView());
    }

    public function testGetDefaultAdminType()
    {
        $this->assertSame(HeaderPagePartAdminType::class, $this->object->getDefaultAdminType());
    }
}
