    ...
    public function adaptForm(AdaptFormEvent $event)
    {
        ...
        if ($page instanceof HasPagePartsInterface) {
            ...
            foreach ($page->getPagePartAdminConfigurations() as $index => $pagePartAdminConfiguration) {
                ...
                $tabPane->addTab(new PagePartTab($pagePartAdminConfiguration->getName(), $page, $this->evemt->getRequest(), $this->em, $pagePartAdminConfiguration, $this->formFactory, $this->pagePartAdminFactory, $types, $data), $position);
            }
        }
    }
