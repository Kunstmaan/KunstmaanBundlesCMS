...
{% endif %}
    ...
    public function setRegex(?string $regex): MultiLineTextPagePart
    {
        $this->regex = $regex;
    ...
    public function setErrorMessageRegex(?string $errorMessageRegex): MultiLineTextPagePart
    {
    ...
    public function setInternalName(?string $internalName): MultiLineTextPagePart
    {
    ...
    public function setRequired(bool $required): MultiLineTextPagePart
    {
    ...
    public function setErrorMessageRequired(?string $errorMessageRequired): MultiLineTextPagePart
    {
    ...
    public function adaptForm(FormBuilderInterface $formBuilder, ArrayObject $fields, $sequence): void
    {
        ...
        $formBuilder->add('formwidget_'.$this->getUniqueId(), TextFormSubmissionType::class, [
            'label' => $this->getLabel(),
