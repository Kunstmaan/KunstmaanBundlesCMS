...
class DefaultPagePartGenerator extends KunstmaanGenerator
{
	...
	$this->renderSingleFile($this->skeletonDir.'/Entity/PageParts/'.$this->entity.'/', $this->bundle->getPath().'/Entity/PageParts/', $this->entity.'.php', $params, true);
	...
	$this->renderSingleFile($this->skeletonDir.'/Form/PageParts/'.$this->entity.'/', $this->bundle->getPath().'/Form/PageParts/', $this->entity.'AdminType.php', $params, true);
	...
	$this->renderSingleFile($this->skeletonDir.'/Resources/views/PageParts/'.$this->entity.'/', $this->bundle->getPath().'/Resources/views/PageParts/'.$this->entity.'/', 'view.html.twig', $params, true);
