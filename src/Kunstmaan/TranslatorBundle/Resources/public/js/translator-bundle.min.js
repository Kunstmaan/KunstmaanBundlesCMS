...
var kunstmaanTranslatorBundle=kunstmaanTranslatorBundle||{};kunstmaanTranslatorBundle.inlineEdit=function(t,n){var a;return a=function(){$.fn.editable.defaults.mode="inline",$(".js-editable").each(function(){var t=$(this),n=t.width();t.on("shown",function(t,a){a.input.$input.css("width",n+50)}),t.editable({showbuttons:"bottom",emptytext:t.data("empty-text"),pk:function(){return t.data("uid")},params:function(n){return n.locale=t.data("locale"),n.domain=t.data("domain"),n.keyword=t.data("keyword"),n.translationId=t.data("tid"),n},success:function(n,a){n.success&&t.data("uid",n.uid)}})})},{init:a}}(window);
var kunstmaanTranslatorBundle=kunstmaanTranslatorBundle||{};kunstmaanTranslatorBundle.app=function(n,a,t){var r;return r=function(){kunstmaanTranslatorBundle.inlineEdit.init()},{init:r}}(jQuery,window),$(function(){kunstmaanTranslatorBundle.app.init()});