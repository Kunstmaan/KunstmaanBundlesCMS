...
class TranslatorController extends AdminListController
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if (!$cacheFresh && !$debugMode) {
            $this->addFlash(
                FlashTypes::INFO,
                $this->getTranslator()->trans('settings.translator.not_live_warning')
            );
        }
    ...
    public function addAction(Request $request, $keyword = '', $domain = '', $locale = '')
    {
        ...
        if ('POST' == $request->getMethod()) {
            ...
            if ($form->isSubmitted() && $form->isValid()) {
                ...
                $this->addFlash(
                    FlashTypes::SUCCESS,
                    $this->getTranslator()->trans('settings.translator.succesful_added')
                );
    ...
    public function editAction(Request $request, $id)
    {
        ...
        if ('POST' == $request->getMethod()) {
            ...
            if ($form->isSubmitted() && $form->isValid()) {
                ...
                $this->addFlash(
                    FlashTypes::SUCCESS,
                    $this->getTranslator()->trans('settings.translator.succesful_edited')
                );
