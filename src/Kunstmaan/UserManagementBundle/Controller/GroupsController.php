...
class GroupsController extends BaseSettingsController
{
    ...
    public function listAction(Request $request)
    {
        ...
        $adminlist = $this->getAdminListFactory()->createList(new GroupAdminListConfigurator($em));
    ...
    public function addAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($form->isSubmitted() && $form->isValid()) {
                ...
                $this->addFlash(
                    FlashTypes::SUCCESS,
                    $this->getTranslator()->trans('kuma_user.group.add.flash.success', array(
    ...
    public function editAction(Request $request, $id)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($form->isSubmitted() && $form->isValid()) {
                ...
                $this->addFlash(
                    FlashTypes::SUCCESS,
                    $this->getTranslator()->trans('kuma_user.group.edit.flash.success', array(
                        '%groupname%' => $group->getName()
                    ))
                );
    ...
    public function deleteAction($id)
    {
        ...
        if (!is_null($group)) {
            ...
            $this->addFlash(
                FlashTypes::SUCCESS,
                $this->getTranslator()->trans('kuma_user.group.delete.flash.success', array(
                    '%groupname%' => $group->getName()
                ))
            );
        }
