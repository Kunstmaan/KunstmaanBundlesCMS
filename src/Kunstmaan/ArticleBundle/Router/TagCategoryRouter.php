...
/**
 * Class TagCategoryRouter
 *
 * @package Kunstmaan\ArticleBundle\Router
 */
    ...
    public function getRouteCollection()
    {
        ...
        if ($this->isMultiLanguage()) {
            foreach ($this->getFrontendLocales() as $locale) {
                ...
                $categoryTrans = $this->translator->trans('article_overview_page.route.category');
                $tagTrans = $this->translator->trans('article_overview_page.route.tag');
