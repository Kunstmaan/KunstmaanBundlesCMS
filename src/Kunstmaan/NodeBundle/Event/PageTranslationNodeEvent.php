...
/**
 * Class PageTranslationNodeEvent
 * @package Kunstmaan\NodeBundle\Event
 */
class PageTranslationNodeEvent extends NodeEvent
{
    /**
     * @var NodeTranslation
     */
    ...
    public function __construct(
        ...
        NodeTranslation $originalNodeTranslation,
        NodeVersion $originalNodeVersion,
        HasNodeInterface $originalPage, $originalLanguage)
    {
