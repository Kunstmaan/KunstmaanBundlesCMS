...
class CipherCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): void
    {
        ...
        switch($method)
        {
            case 0:
            case 1:
                $this->textMethods($helper, $method, $input, $output);
                break;
            case 2:
            case 3:
                $this->fileMethods($helper, $method, $input, $output);
                break;
        }
    }

    private function textMethods(
    ...
    ): void
    {
        ...
        $question->setMaxAttempts(self::ATTEMPS);
