...
(function(){
    var a=function(b,c){
        ...
        return{
            title:b.lang.image[c=='image'?'title':'titleButton'],minWidth:420,minHeight:360,onShow:function(){
                var I=this;I.imageElement=false;
                I.linkElement=false;
                ...
                if(C==d){
                    var E=D.data('cke-saved-src')||D.getAttribute('src'),F=this;this.getDialog().dontResetSize=true;
                    F.setValue(E);
                    F.setInitValue();
                }
            },commit:function(C,D){
                ...
                if(C){C.on('click',function(E){q(this);
                ...
                if(C==d||C==f){
                    ...
                    }else if(!F&&this.isChanged()){D.removeStyle('margin-top');
                ...
                if(C==d)
                    if(this.getValue()||this.isChanged())D.setAttribute('id',this.getValue());
            }
                ...
                if(C==d)
                    if(this.getValue()||this.isChanged())D.setAttribute('lang',this.getValue());
            }
            }]
                ...
                if(C==d)
                    if(this.getValue()||this.isChanged())D.setAttribute('longDesc',this.getValue());
            }
                ...
                if(C==d)
                    if(this.getValue()||this.isChanged())D.setAttribute('class',this.getValue());
            }
                ...
                o.call(this,['info:cmbFloat','info:cmbAlign','info:txtVSpace','info:txtHSpace','info:txtBorder','info:txtWidth','info:txtHeight']);l(this);},commit:function(C,D){
