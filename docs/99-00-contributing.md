...
We follow most of the procedures for contributions from the [Symfony](http://symfony.com/doc/current/contributing/index.html) and [KunstmaanBundlesCMS](https://bundles.kunstmaan.be) project, as such much of this info will look familiar as it embodies current best practices.
